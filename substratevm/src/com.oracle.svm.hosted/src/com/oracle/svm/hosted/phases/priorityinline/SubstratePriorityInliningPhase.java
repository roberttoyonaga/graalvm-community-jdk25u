...
public class SubstratePriorityInliningPhase extends PriorityInliningPhase {
    ...
    private class SubstrateCallTree extends CallTree {
        ...
        @Override
        public void devirtualizeHotCallees(jdk.graal.compiler.nodes.spi.CoreProviders coreProviders) {
            /* No PGO data available — hot-callee devirtualization is disabled. */
        }
